...
MAX_STEPS=500000
BATCH_SIZE=24                          # A AFFINER au benchmark B200 (etape 4)
GRAD_ACCUM=2                           # tokens/step = batch*grad_accum*ctx ; vise 65536
LR=3e-4
WARMUP=2000
...
EVAL_EVERY=2000
LOG_EVERY=50
NUM_WORKERS=8                          # B200 host a plus de vCPU que la 3090
PREFETCH_FACTOR=4
COMPILE_MODE="default"                 # A AFFINER : reduce-overhead / max-autotune (etape 4)
SEED=1234
